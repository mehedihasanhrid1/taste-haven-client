...
const Navbar = ({ isDarkMode, toggleDarkMode }) => {
  ...
  return (
    <div>
      <nav className="py-4 px-2 md:p-5 shadow flex items-center justify-between dark:bg-gradient-to-r dark:from-gray-900 dark:via-gray-700 dark:to-gray-900">
        ...
        <img className='rounded-full h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10' src="https://i.ibb.co/fY089MJ/man-icon.jpg" alt="" />
          <span className="group-hover:opacity-100 transition-opacity bg-gray-800 dark:bg-gray-100 dark:text-gray-800 px-3 py-2 text-sm text-gray-100 rounded-md absolute left-1/2 
    -translate-x-1/2 translate-y-full opacity-0 mt-3 lg:mt-5">mehedihasanhrid@gmail.com</span>
            ...
            <Link to="/login">
            <button className='bg-[#289944] text-white px-4 md:px-6 md:text-lg py-2 hover:bg-[#248a3e] dark:bg-[#FB9333] dark:hover:bg-[#dd7614] rounded-lg'>Login</button>
            </Link>    
        </div>
      </nav>
    </div>
